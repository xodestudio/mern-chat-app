        ...
        <div className="overflow-y-auto">
          <div className="p-4 flex items-center space-x-3 hover:bg-gray-700 cursor-pointer">
            <div className="relative">
              ...
              />
              <BsFillCircleFill className="absolute bottom-0 right-0 text-green-500 text-[10px]" />
            </div>
            <div>
              <h2 className="text-base font-semibold">Scarlett Johansson</h2>
              <p className="text-sm text-gray-400">You sent a photo. 1h</p>
            </div>
            <BsFillCircleFill className="text-blue-500 text-[10px] ml-auto" />
          </div>
          ...
          <div className="p-4 flex items-center space-x-3 hover:bg-gray-700 cursor-pointer">
            ...
            <div>
              <h2 className="text-base font-semibold">Tony Stark</h2>
